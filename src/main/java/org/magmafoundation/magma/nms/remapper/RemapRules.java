...
import org.magmafoundation.magma.nms.remapper.proxy.ProxyClassLoader;
import org.magmafoundation.magma.nms.remapper.proxy.ProxyURLClassLoader;
import org.magmafoundation.magma.nms.remapper.proxy.ProxyMethodHandle;
import org.magmafoundation.magma.nms.remapper.proxy.ProxyReflection;
...
public class RemapRules {
    private static final String NMSPackage = "net.minecraft.server." + Magma.getBukkitVersion();
