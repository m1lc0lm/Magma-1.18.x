...
public class RemapUtils {
    ...
    public static String map(String typeName) {
        ...
        return ReflectionTransformer.jarMapping.classes.getOrDefault(typeName, typeName);
    }

    public static String mapPackage(String typeName) {
        for (Map.Entry<String, String> entry : ReflectionTransformer.jarMapping.packages.entrySet()) {
